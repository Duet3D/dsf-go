...
import (
	"github.com/Duet3D/dsf-go/dsf/v3/machine/boards"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/directories"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/fans"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/heat"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/httpendpoints"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/inputs"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/job"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/limits"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/messages"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/move"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/network"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/plugins"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/scanner"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/sensors"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/spindles"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/state"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/tool"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/usersessions"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/uservariables"
	"github.com/Duet3D/dsf-go/dsf/v3/machine/volume"
)
