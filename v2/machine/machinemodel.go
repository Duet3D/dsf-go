...
import (
	"github.com/Duet3D/dsf-go/v2/machine/boards"
	"github.com/Duet3D/dsf-go/v2/machine/directories"
	"github.com/Duet3D/dsf-go/v2/machine/fans"
	"github.com/Duet3D/dsf-go/v2/machine/heat"
	"github.com/Duet3D/dsf-go/v2/machine/httpendpoints"
	"github.com/Duet3D/dsf-go/v2/machine/inputs"
	"github.com/Duet3D/dsf-go/v2/machine/job"
	"github.com/Duet3D/dsf-go/v2/machine/limits"
	"github.com/Duet3D/dsf-go/v2/machine/messages"
	"github.com/Duet3D/dsf-go/v2/machine/move"
	"github.com/Duet3D/dsf-go/v2/machine/network"
	"github.com/Duet3D/dsf-go/v2/machine/scanner"
	"github.com/Duet3D/dsf-go/v2/machine/sensors"
	"github.com/Duet3D/dsf-go/v2/machine/spindles"
	"github.com/Duet3D/dsf-go/v2/machine/state"
	"github.com/Duet3D/dsf-go/v2/machine/tool"
	"github.com/Duet3D/dsf-go/v2/machine/usersessions"
	"github.com/Duet3D/dsf-go/v2/machine/uservariables"
	"github.com/Duet3D/dsf-go/v2/machine/volume"
)
